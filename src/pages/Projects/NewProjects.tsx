...
const projects = [
  {
    ...
    projectDescription: "Participate in a survey to help improve AI models. This project involves answering simple questions. There are no specific skills required, just a willingness to share your thoughts.",
  },
  {
    id: 2,
        ...
        {projects.map((project) => (
          ...
          >
            <div className="space-y-2">
              <h3 className="text-xl font-semibold text-[#F6921E]">{project.title}</h3>
              <div className="text-sm text-gray-700">
                ...
                <p>
                  Pay:{" "}
                  <span className="font-medium text-black">{project.pay}</span>
                </p>
                <div className="transition-all duration-300 ease-in-out">
                  <p className="underline text-[#838281] cursor-pointer" onClick={() => handleOpen(project.id)}>
                    Read More
                  </p>
                  <div
                    className={`overflow-hidden transition-all duration-300 ease-in-out ${
                      open === project.id ? "max-h-40 opacity-100 mt-2" : "max-h-0 opacity-0"
