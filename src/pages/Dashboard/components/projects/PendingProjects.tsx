...
const Pendingprojects = () => {
  ...
  return (
    <div className=" font-[gilroy-regular] flex flex-col gap-2">
       ...
       {
            pendingProjects.map((project, index) => ( <div className=" h-[20rem] w-[20rem] flex flex-col bg-white rounded-md hover:shadow-primary hover:shadow-sm cursor-pointer">
                {/* Image */}
                ...
                <div className=" p-4 flex flex-col justify-between h-full">
                        ...
                        <div className=" w-full flex justify-between ">
                                ...
                                {/* Action */}
                                <span className=" text-gray-300 cursor-pointer"> <ClockCircleOutlined/> Pending</span>
                        </div>
                </div>
            </div>))
        }
