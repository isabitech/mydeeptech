...
const Rejected = () => {
    const rejected = [
      ...
      return (
        <div>
          <p>
            Your Rejected Jobs as at {todaysDate} {"-"} {month} {"-"} {year}{" "}
          </p>
          {/* Todays Task */}
          <div className="  w-full h-[70vh] overflow-y-auto flex flex-col gap-2 pt-4">
            <p className="text-primary">Rejected Jobs</p>
            ...
            >
              <thead className=" text-left">
                <tr className=" ">
                  ...
                  <th className="p-2 font-normal">rejected Date</th>
              ...
              <tbody className=" h-full overflow-auto">
                ...
                {rejected.map((row, index) => (
                  <tr className=" " key={row.id}>
                    ...
                    <td className="p-2 ">{row.rejectedDate}</td>
